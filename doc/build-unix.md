UNIX BUILD NOTES
====================
Some notes on how to build LiteRedMoreMore in Unix.
...
memory available when compiling LiteRedMoreMore. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build LiteRedMoreMore without wallet.
...
If you want to build LiteRedMoreMore-Qt, make sure that the required packages for Qt development
...
# Configure LiteRedMoreMore to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
As mentioned above, when maintaining portability of the wallet between the standard LiteRedMoreMore distributions and independently built
