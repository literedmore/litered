    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextLiteRedMoreMore   = QChar(0xA9)+QString(" %1 ").arg(2023) + QString("The LiteRedMoreMore developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextLiteRedMoreMore);
    }
